...
//
// Differences from the original key_table.h:
// - Removed #include <X11/keysym.h> and #include <rime_api.h>.
// - Removed runtime function declarations (RimeGetModifierByName, etc.);
//   those are generated by bindgen from rime_api.h instead.
// - Indentation changed from 2 spaces to 4 spaces.
// - Enum values are identical to the original.
